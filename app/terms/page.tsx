  ...
  return (
    <div className="min-h-screen flex flex-col bg-cream-50">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 md:px-6 py-12 w-full space-y-6 text-xs text-slate-700 leading-relaxed">
        <h1 className="text-3xl font-serif font-bold text-slate-900">Terms & Conditions</h1>
        <div className="bg-white p-6 rounded-2xl border border-cream-300 space-y-4">
          <p>Welcome to SR Jewellery Collections. All transactions and catalogue purchases are governed by Indian consumer protection laws.</p>
        </div>
      </main>
      <WhatsAppFloat />
      <Footer />
